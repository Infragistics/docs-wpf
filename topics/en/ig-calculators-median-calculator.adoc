...
In order to use the link:{ApiPlatform}math.calculators{ApiVersion}~infragistics.math.calculators.mediancalculator.html[MedianCalculator], the following NuGet package must be added to a {PlatformName} project.
