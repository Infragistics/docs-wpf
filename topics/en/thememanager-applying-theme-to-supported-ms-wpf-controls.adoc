...
* <<_Ref397277890,Related Topics>>

[[_Ref397277880]]
== Supported Microsoft WPF controls

The following list shows the Microsoft WPF controls which are supported by the ThemeManager. You can see the available themes in the link:ms-controls-implicit-themes.html[MS Controls Implicit Themes] topic.
