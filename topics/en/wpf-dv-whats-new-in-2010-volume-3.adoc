...
The {ProductName} Data Visualization 2010 Volume 3 release contains a new Drag and Drop Framework. This framework provides the necessary pieces to make it as simple as possible to add drag and drop functionality to your application. This allows for real-time moving of elements and more user-friendly interactions.
...
link:excelengine-about-infragistics-excel-engine.html[About Infragistics Excel Engine]
