...
* [required] Create a class that derives from link:{ApiPlatform}datavisualization{ApiVersion}~infragistics.controls.datasource.asyncvirtualdatasourceproviderworker.html[AsyncVirtualDataSourceProviderWorker].
