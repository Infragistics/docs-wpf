...
.. Add an unbound fields whose values will be calculated.
+
...
+
--
... Add a field (in this case NumericField) and set its Name and Label (optional) properties
... Set its BindingType property to Unbound
... Declare tags for the CalculationSettings property of the field
