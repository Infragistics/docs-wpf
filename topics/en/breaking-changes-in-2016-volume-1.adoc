...
The following table summarizes the breaking changes of the {ProductName} 2016 Volume 1 Release. Detailed explanations of the issues are provided after the summary table.
