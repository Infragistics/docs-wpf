...
[NOTE]
====
In order to control when to display connection points for a node, use the link:{ApiPlatform}controls.charts.xamdiagram{ApiVersion}~infragistics.controls.charts.xamdiagram~connectionpointsdisplaymode.html[ConnectionPointsDisplayMode] property. For details on using this property, refer to link:xamdiagram-nodes-connection-points.html[Configuring the Connection Points of the Diagram Nodes].
====
...
| link:xamdiagram-nodes-connection-points.html[Configuring the Connection Points of the Diagram Nodes ( _xamDiagram_ )]
