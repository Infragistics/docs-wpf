...
The  _xamRadialMenu_   control supports several item types, all of which are derived from the link:{ApiPlatform}controls.menus.xamradialmenu{ApiVersion}~infragistics.controls.menus.radialmenuitembase_members.html[RadialMenuItemBase] base class.
