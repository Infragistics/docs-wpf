...
You can also control how many levels deep the xamGrid will traverse the self-related data structure by setting the control's link:{ApiPlatform}controls.grids.xamgrid{ApiVersion}~infragistics.controls.grids.xamgrid~maxdepth.html[MaxDepth] property.
