...
The following table lists the internal serialization providers of the *Infragistics.WPF.RichTextDocument* NuGet package and their supported content formats used by the  _xamRichTextEditor_   when reading or writing data to the clipboard:
