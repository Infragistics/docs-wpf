...
+
In order to use a ResourceWasher in your application, you must add the Infragistics.WPF NuGet package to your project. For more information on setting up the NuGet feed and adding NuGet packages, you can take a look at the following documentation: link:nuget-feeds.html[NuGet Feeds].
