...
* <<_Ref372811120,Code Example: Configuring CurrencyField>>
...
|<<_Ref372811120,Configuring CurrencyField>>
...
The following code snippet demonstrates how to use the link:{ApiPlatform}datapresenter{ApiVersion}~infragistics.windows.datapresenter.currencyfield_members.html[CurrencyField] when configured as follows:
