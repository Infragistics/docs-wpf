...
For more information on configuring connection points for a node refer to link:xamdiagram-nodes-connection-points.html[Configuring the Connection Points of the Diagram Nodes].
