...
You can use the document adapters to bind the  _xamRichTextEditor’s_   document to various data formats. The following table lists the available document adapters and the NuGet packages in which they are located:
