...
You can use the link:excelengine-about-infragistics-excel-engine.html[Infragistics Excel Engine] to manipulate different types of shapes (rectangle, line, etc.).
...
* link:excelengine-adding-a-shape-to-an-excel-worksheet.html[Adding a Shape to a Worksheet (Infragistics Excel Engine)]
* link:excelengine-customizing-excel-shapes.html[Customizing Shapes (Infragistics Excel Engine)]
* link:excelengine-grouping-excel-shapes.html[Grouping Shapes (Infragistics Excel Engine)]
* link:excelengine-importing-shapes-from-excel.html[Importing Shapes from Excel (Infragistics Excel Engine)]
