...
| link:xamdata-terms-presentation-formats-tree-view-format.html[Tree View] -- Presents regular arrangements of rows and columns in a grid-like structure, but in addition there is a special tree-field which is used to browse and navigate through hierarchical data.
