...
The control's resource files are available publicly in our link:https://github.com/Infragistics/wpf-resources/tree/main/ResourceStrings[WPF Resources GitHub repository].
