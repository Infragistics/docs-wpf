...
* The  _xamPivotGrid_   control added to your page (as described in the link:xampivotgrid-getting-started-with-xampivotgrid.html[Getting Started with xamPivotGrid topic.] 

* Reference to the  *Infragistics.WPF.Reporting* NuGet package added to the project
