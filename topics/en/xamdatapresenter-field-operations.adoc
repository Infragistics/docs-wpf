...
| link:xamdatagrid-cell-merging.html[Cell Merging ( _xamDataPresenter_ )]
|This topic explains how to define and customize merged cells in the _xamDataPresenter_ .
