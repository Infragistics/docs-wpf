...
The assemblies names have been changed - the prefix *Infragistics3.Wpf* is now changed to *InfragisticsWPF3*. Also the .NET 4.0 assemblies are using the *{ApiPlatform}* prefix.
