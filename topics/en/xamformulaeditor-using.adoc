...
Next, you need to add the necessary using/Imports directives in your code-behind or the Infragistics xml namespace for XAML as shown in link:xamformulaeditor-using.html#Listing1[Listing 1] and to add the xamFormulaEditor itself.
[start=2]
. *Configuring the xamFormulaEditor*
