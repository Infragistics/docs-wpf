...
| link:{RootAssembly}{ApiVersion}.html[{ApiPlatform}dll]
|{ProductName} assembly containing functionality used by the Infragistics assemblies.

| link:{ApiPlatform}datavisualization{ApiVersion}.html[{ApiPlatform}DataVisualization.dll]
...
| link:{ApiPlatform}dragdrop{ApiVersion}.html[{ApiPlatform}DragDrop.dll]
...
| link:{ApiPlatform}documents.core{ApiVersion}.html[{ApiPlatform}Documents.Core.dll]
|{ProductName} assembly containing core documents related functionality

| link:{ApiPlatform}documents.excel{ApiVersion}.html[{ApiPlatform}Documents.Excel.dll]
|{ProductName} assembly containing Excel related documents functionality

| link:{ApiPlatform}documents.io{ApiVersion}.html[{ApiPlatform}Documents.IO.dll]
|{ProductName} assembly containing IO operations documents related functionality

| link:{ApiPlatform}documents.richtextdocument{ApiVersion}.html[{ApiPlatform}Documents.RichTextDocument.dll]
|{ProductName} assembly containing rich text documents related functionality

| link:{ApiPlatform}documents.richtextdocument{ApiVersion}.html[{ApiPlatform}Documents.RichTextDocument.Html.dll]
|{ProductName} assembly containing rich text documents HTML related functionality

| link:{ApiPlatform}documents.richtextdocument.rtf{ApiVersion}.html[{ApiPlatform}Documents.RichTextDocument.Rtf.dll]
|{ProductName} assembly containing rich text documents RTF related functionality

| link:{ApiPlatform}documents.richtextdocument.word{ApiVersion}.html[{ApiPlatform}Documents.RichTextDocument.Word.dll]
|{ProductName} assembly containing rich text documents Word related functionality

| link:{ApiPlatform}documents.textdocument{ApiVersion}.html[{ApiPlatform}Documents.TextDocument.dll]
|{ProductName} assembly containing text documents related functionality

| link:{ApiPlatform}documents.textdocument.csharp{ApiVersion}.html[{ApiPlatform}Documents.TextDocument.CSharp.dll]
|{ProductName} assembly containing text documents C# related functionality

| link:{ApiPlatform}documents.textdocument.tsql{ApiVersion}.html[{ApiPlatform}Documents.TextDocument.TSql.dll]
|{ProductName} assembly containing text documents TSQL related functionality

| link:{ApiPlatform}documents.textdocument.visualbasic{ApiVersion}.html[{ApiPlatform}Documents.TextDocument.VisualBasic.dll]
...
| link:{ApiPlatform}controls.barcodes.barcodereader{ApiVersion}.html[{ApiPlatform}Controls.Barcodes.BarcodeReader.dll]
...
| link:{ApiPlatform}persistence{ApiVersion}.html[{ApiPlatform}Persistence.dll]
...
| link:{ApiPlatform}documents.excel{ApiVersion}.html[{ApiPlatform}Documents.Core.dll]
|{ProductName} assembly containing core documents related functionality
...
| link:{ApiPlatform}math{ApiVersion}.html[{ApiPlatform}Math.dll]
...
| link:{ApiPlatform}math.calculators{ApiVersion}.html[{ApiPlatform}Math.Calculators.dll]
...
| link:{ApiPlatform}reporting{ApiVersion}.html[{ApiPlatform}Reporting.dll]
...
| link:{ApiPlatform}controls.barcodes{ApiVersion}.html[{ApiPlatform}Controls.Barcodes.dll]
...
| link:{ApiPlatform}controls.gauges{ApiVersion}.html[{ApiPlatform}Controls.Gauges.dll]
...
| link:{ApiPlatform}calculations.xamcalculationmanager{ApiVersion}.html[{ApiPlatform}Calculations.XamCalculationManager.dll]
...
| link:{ApiPlatform}controls.editors.xamcalendar{ApiVersion}.html[{ApiPlatform}Controls.Editors.XamCalendar.dll]
...
| link:{ApiPlatform}controls.editors.xamcolorpicker{ApiVersion}.html[{ApiPlatform}Controls.Editors.XamColorPicker.dll]
...
| link:{ApiPlatform}controls.editors.xamcomboeditor{ApiVersion}.html[{ApiPlatform}Controls.Editors.XamComboEditor.dll]
...
| link:{ApiPlatform}controls.menus.xammenu{ApiVersion}.html[{ApiPlatform}Controls.Menus.XamMenu.dll]
...
| link:{ApiPlatform}datapresenter{ApiVersion}.html[{ApiPlatform}DataPresenter.dll]
|{ProductName} Assembly containing the xamDataCarousel control.

| link:{ApiPlatform}editors{ApiVersion}.html[{ApiPlatform}Editors.dll]
...
| link:{ApiPlatform}controls.charts.xamdatachart{ApiVersion}.html[{ApiPlatform}Controls.Charts.XamDataChart.dll]
...
| link:{ApiPlatform}controls.charts.olap{ApiVersion}.html[{ApiPlatform}Controls.Charts.Olap.dll]
...
| link:{ApiPlatform}olap{ApiVersion}.html[{ApiPlatform}Olap.dll]
...
| link:{ApiPlatform}controls.menus.xamdatatree{ApiVersion}.html[{ApiPlatform}Controls.Menus.XamDataTree.dll]
...
| link:{ApiPlatform}datapresenter.calculationadapter{ApiVersion}.html[{ApiPlatform}DataPresenter.CalculationAdapter.dll]
|{ProductName} Assembly containing the CalculationAdapter class.

| link:{ApiPlatform}datapresenter.excelexporter{ApiVersion}.html[{ApiPlatform}DataPresenter.ExcelExporter.dll]
|{ProductName} Assembly containing the DataPresenterExcelExporter class.

| link:{ApiPlatform}datapresenter.datasources.async{ApiVersion}.html[{ApiPlatform}DataPresenter.DataSources.Async.dll]
|{ProductName} Assembly containing the AsyncPagingDataSourceBase class.

| link:{ApiPlatform}datapresenter.wordwriter{ApiVersion}.html[{ApiPlatform}DataPresenter.WordWriter.dll]
...
| link:{ApiPlatform}controls.editors.xammaskedinput{ApiVersion}.html[{ApiPlatform}Controls.Editors.XamMaskedInput.dll]
|{ProductName} assembly containing the MaskedInput controls

| link:{ApiPlatform}controls.editors.xamdatetimeinput{ApiVersion}.html[{ApiPlatform}Controls.Editors.XamDateTimeInput.dll]
...
| link:{ApiPlatform}controls.charts.xamdiagram{ApiVersion}.html[{ApiPlatform}Controls.Charts.xamDiagram.dll]
...
| link:{ApiPlatform}controls.interactions.xamdialogwindow{ApiVersion}.html[{ApiPlatform}Controls.Interactions.XamDialogWindow.dll]
...
| link:{ApiPlatform}dockmanager{ApiVersion}.html[{ApiPlatform}DockManager.dll]
...
| link:{ApiPlatform}controls.interactions.xamformulaeditor{ApiVersion}.html[{ApiPlatform}Controls.Interactions.XamFormulaEditor.dll]
...
| link:{ApiPlatform}controls.schedules.xamgantt{ApiVersion}.html[{ApiPlatform}Controls.Schedules.XamGantt.dll]
|{ProductName} assembly containing the xamGantt control

| link:{ApiPlatform}datamanager{ApiVersion}.html[{ApiPlatform}DataManager.dll]
|{ProductName} assembly containing the DataManager component

| link:{ApiPlatform}controls.schedules{ApiVersion}.html[{ApiPlatform}Controls.Schedules.dll]
|{ProductName} assembly containing the schedule related controls

| link:{ApiPlatform}controls.editors.xamcalendar{ApiVersion}.html[{ApiPlatform}Controls.Editors.XamCalendar.dll]
|{ProductName} assembly containing the xamCalendar control

| link:{ApiPlatform}controls.grids.xamgrid{ApiVersion}.html[{ApiPlatform}Controls.Grids.XamGrid.dll]
...
| link:{ApiPlatform}controls.maps.xamgeographicmap{ApiVersion}.html[{ApiPlatform}Controls.Maps.XamGeographicMap.dll]
...
| link:{ApiPlatform}controls.grids.datetimecolumn{ApiVersion}.html[{ApiPlatform}Controls.Grids.DateTimeColumn.dll]
|{ProductName} assembly containing the DateTime column for the xamGrid control

| link:{ApiPlatform}controls.grids.multicolumncombocolumn{ApiVersion}.html[{ApiPlatform}Controls.Grids.MultiColumnComboColumn.dll]
|{ProductName} assembly containing the MultiColumnComboBox column for the xamGrid control

| link:{ApiPlatform}controls.grids.sparklinecolumn{ApiVersion}.html[{ApiPlatform}Controls.Grids.SparklineColumn.dll]
...
| link:{ApiPlatform}controls.maps.xammap{ApiVersion}.html[{ApiPlatform}Controls.Maps.XamMap.dll]
...
| link:{ApiPlatform}controls.maps.xamnetworknode{ApiVersion}.html[{ApiPlatform}Controls.Maps.XamNetworkNode.dll]
...
| link:{ApiPlatform}controls.maps.xamorgchart{ApiVersion}.html[{ApiPlatform}Controls.Maps.XamOrgChart.dll]
...
| link:{ApiPlatform}outlookbar{ApiVersion}.html[{ApiPlatform}OutlookBar.dll]
...
| link:{ApiPlatform}controls.grids.xampivotgrid{ApiVersion}.html[{ApiPlatform}Controls.Grids.XamPivotGrid.dll]
...
| link:{ApiPlatform}controls.grids.xampivotdataslicer{ApiVersion}.html[{ApiPlatform}Controls.Grids.XamPivotDataSlicer.dll]
...
* link:{ApiPlatform}olap.xmla{ApiVersion}.html[{ApiPlatform}Olap.Xmla.dll] 

* link:{ApiPlatform}olap.xmla.oracle{ApiVersion}.html[{ApiPlatform}Olap.Xmla.Oracle.dll] 

* link:{ApiPlatform}olap.xmla.sap{ApiVersion}.html[{ApiPlatform}Olap.Xmla.Sap.dll] 

* link:{ApiPlatform}olap.flatdata{ApiVersion}.html[{ApiPlatform}Olap.FlatData.dll] 

* link:{ApiPlatform}olap.excel{ApiVersion}.html[{ApiPlatform}Olap.Excel.dll] 

* link:{ApiPlatform}olap.adomd{ApiVersion}.html[{ApiPlatform}Olap.Adomd.dll] 
...
| link:{ApiPlatform}controls.editors.xampropertygrid{ApiVersion}.html[{ApiPlatform}Controls.Editors.XamPropertyGrid.dll]
...
| link:{ApiPlatform}controls.gauges{ApiVersion}.html[{ApiPlatform}Controls.Gauges.dll]
|{ProductName} assembly containing the link:{ApiPlatform}controls.gauges{ApiVersion}~infragistics.controls.gauges.xamradialgauge.html[{RadialGaugeName}] control.
...
| link:{ApiPlatform}controls.menus.xamradialmenu{ApiVersion}.html[{ApiPlatform}Controls.Menus.XamRadialMenu.dll]
...
| link:{ApiPlatform}ribbon{ApiVersion}.html[{ApiPlatform}Ribbon.dll]
...
| link:{ApiPlatform}controls.editors.xamrichtexteditor{ApiVersion}.html[{ApiPlatform}Controls.Editors.XamRichTextEditor.dll]
...
| link:{ApiPlatform}undo{ApiVersion}.html[{ApiPlatform}Undo.dll]
...
| link:{ApiPlatform}controls.schedulesdialogs{ApiVersion}.html[{ApiPlatform}Controls.SchedulesDialogs.dll]
...
| link:{ApiPlatform}controls.schedulesexchangeconnector{ApiVersion}.html[{ApiPlatform}Controls.SchedulesExchangeConnector.dll]
...
| link:{ApiPlatform}controls.editors.xamslider{ApiVersion}.html[{ApiPlatform}Controls.Editors.XamSlider.dll]
...
| link:{ApiPlatform}controls.charts.xamsparkline{ApiVersion}.html[{ApiPlatform}Controls.Charts.XamSparkline.dll]
...
| link:{ApiPlatform}controls.charts.xamsurfacechart3d{ApiVersion}.html[{ApiPlatform}Controls.Charts.XamSurfaceChart3D.dll]
...
| link:{ApiPlatform}controls.interactions.xamspellchecker{ApiVersion}.html[{ApiPlatform}Controls.Interactions.XamSpellChecker.dll]
...
| link:{ApiPlatform}controls.grids.xamspreadsheet{ApiVersion}.html[{ApiPlatform}Controls.Grids.XamSpreadsheet.dll]
...
| link:{ApiPlatform}controls.editors.xamsyntaxeditor{ApiVersion}.html[{ApiPlatform}Controls.Editors.XamSyntaxEditor.dll]
...
| link:{ApiPlatform}controls.menus.xamtagcloud{ApiVersion}.html[{ApiPlatform}Controls.Menus.XamTagCloud.dll]
...
| link:{ApiPlatform}controls.layouts.xamtilemanager{ApiVersion}.html[{ApiPlatform}Controls.Layouts.XamTileManager.dll]
...
| link:{ApiPlatform}controls.timelines.xamtimeline{ApiVersion}.html[{ApiPlatform}Controls.Timelines.XamTimeline.dll]
...
| link:{ApiPlatform}controls.charts.xamtreemap{ApiVersion}.html[{ApiPlatform}Controls.Charts.XamTreemap.dll]
