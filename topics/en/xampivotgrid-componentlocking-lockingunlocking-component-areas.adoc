...
[NOTE]
====
The data source type of the _xamPivotGrid_ control determines what OLAP NuGet package references are required. Refer to the link:developers-guide-deploying-your-application.html[Deploying Your Application] topic for the complete list of required assemblies used by components of the _xamPivotGrid_ control and its data sources.
====
