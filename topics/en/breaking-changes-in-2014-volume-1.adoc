...
The following table summarizes the breaking changes of the {ProductName} 2014 Volume 1 Release. Detailed explanations of the issues and the existing workarounds are provided after the summary table.
...
Renaming of members in the  *{ApiPlatform}Controls.Maps.XamGeographicMap{ApiVersion}.dll*  assembly:
...
Removing of members in the  *{ApiPlatform}Controls.Maps.XamGeographicMap{ApiVersion}.dll*  assembly:
...
Renaming of members in the  *{ApiPlatform}Controls.Editors.XamRichTextEditor{ApiVersion}.dll*  assembly:
...
Renaming of members in the  *{ApiPlatform}Controls.Editors.XamSyntaxEditor{ApiVersion}.dll*  assembly:
