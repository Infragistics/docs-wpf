...
|A custom `Style` with `TargetType` link:{ApiPlatform}controls.grids.xampivotgrid{ApiVersion}~infragistics.controls.grids.hiddenaxischooser_members.html[HiddenAxisChooser]
