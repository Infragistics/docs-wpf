...
|metadata|
{
    ...
    "tags": [],
    "guid": "{A6B43C3E-28F6-40E7-8E31-073DFB0C108E}","buildFlags": [],
...
The Data Presenter Family is the grouping for the {ProductName} data-driven controls (xamDataCarousel™, xamDataGrid™, xamTreeGrid™, xamDataCards™, and xamDataPresenter™). These controls are in this family because the base functionality for these controls is the same.
