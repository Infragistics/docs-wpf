...
The {ProductName} controls support link:https://msdn.microsoft.com/en-us/library/windows/desktop/ee684009.aspx[Microsoft® UI Automation]. This framework is available on all operating systems that support Windows Presentation Foundation (WPF). This topic explains the automation supported by specific controls and their limitations.
