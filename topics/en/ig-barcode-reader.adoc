...
|metadata|
{
    ...
    "tags": [],
    "guid": "7a286aca-f320-4a20-8bf3-b015aa2d1caa","buildFlags": [],
...
+
Add the following NuGet package to your application. For more information on setting up the NuGet feed and adding NuGet packages, you can take a look at the following documentation: link:nuget-feeds.html[NuGet Feeds].
