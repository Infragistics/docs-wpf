...
[start=4]
. Within the {LinearGaugeName} control, set the Style property to the Style you created

*In XAML:*

----
<Grid x:Name="layoutRoot">
        <ig:{LinearGaugeName} x:Name="xamLinearGauge1" 
                           Margin="5"
                           FontSize="16"
...
[start=5]
. Save and run your application. The following image shows how the {LinearGaugeName} control might look with this custom style.
