...
[start=2]
. Create a DataTemplate. The deferred scrolling template’s data context is a link:{ApiPlatform}controls.grids.xamgrid{ApiVersion}~infragistics.scrolltipinfo.html[ScrollTipInfo] object; therefore, you can bind the following properties exposed by the ScrollTipInfo object within this data template.
