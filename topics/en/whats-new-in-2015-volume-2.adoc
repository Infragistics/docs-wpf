...
This topic gives a brief overview of the new controls and features introduced in the {ProductName} 2015 Volume 2 Release.
...
link:excelengine-addingtabletoworksheet.html[Adding a Table to a Worksheet (Infragistics Excel Engine)]
