...
The following table summarizes the breaking changes of the {ProductName} 2014 Volume 2 Release. Detailed explanations of the issues and the existing workarounds are provided after the summary table.
...
|<<_Ref398294256,Deprecating the UnboundField type>>
...
Until {ProductName} 2014 Volume 2 Release, the _xamColorPicker_ `SelectedColorChanged` event was triggered every time a user hovers over a color in the _xamColorPicker_ palettes.
