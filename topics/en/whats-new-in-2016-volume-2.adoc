...
This topic gives a brief overview of the new controls and features introduced in the {ProductName} 2016 Volume 2 Release.

== xamCategoryChart


A new control, the Category Chart, is added in the {ProductName} 2016 volume 2 release. This chart can be easily configured to display category data using a simple API. All you need to do is bind your data (a collection or a collection of collections).
