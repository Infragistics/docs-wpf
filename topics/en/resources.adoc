...
ifdef::wpf[]
* link:resources-productdata.html[ProductData]
...
* link:resources-xamgantt-custom-calendar-code-example.html[Custom Calendar]
* link:resources-xamgantt-custom-project-column-code-example.html[Custom Project Column]
* link:resources-xamgantt-custom-project-table-code-example.html[Custom Project Table]
* link:resources-xamgantt-custom-project-view-code-example.html[Custom Project View]
* link:resources-xamgantt-custom-task-code-example.html[Custom Task]