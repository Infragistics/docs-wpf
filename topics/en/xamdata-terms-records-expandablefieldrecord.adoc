...
|metadata|
{
    ...
    "tags": [],
    "guid": "{19ED9576-AC9C-4D40-84A0-62304046E497}","buildFlags": [],
...
[NOTE]
====
The xamTreeGrid™ control is also capable of display hierarchical data but it is shown in a slightly different way using a "tree field". You can find more related information in the xamTreeGrid's link:xamtreegrid-features-overview.html[Features Overview] topic.
====
