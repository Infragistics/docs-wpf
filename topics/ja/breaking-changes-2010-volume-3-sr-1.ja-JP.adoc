...
= 2010 Volume 3 11 月サービス リリース

== XamRadialGauge

XamRadialGauge™ コントロールのテンプレート RootElement は ContentPresenter の代わりにグリッドになります。テンプレートを編集する XamRadialGauge コントロールのすべての既存のスタイルは、ランタイムでのエラーを防ぐために更新する必要があります。
