...
xamMap コントロールはシェープファイルから派生した情報を表示します。たとえば、シェープファイルが米国マップの情報を含む場合、xamMap はこのマップを表示します。シェープファイルと構成の詳細は、 link:xamwebmap-understanding-xamwebmap.html[「シェープファイルについて」]を参照してください。
